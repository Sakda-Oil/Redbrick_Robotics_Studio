...
.head{display:flex;align-items:center;justify-content:space-between;padding:14px 16px;border-bottom:1px solid var(--vscode-panel-border);flex:none}.heading{display:flex;align-items:center;gap:10px}
h1{font-size:16px;margin:0}.mode{padding:3px 7px;border-radius:10px;background:var(--vscode-badge-background);color:var(--vscode-badge-foreground);font-size:11px}.connected{padding:12px 16px;border-bottom:1px solid var(--vscode-panel-border);flex:none}
